...
<<CHART-GEOM, echo=FALSE>>=
grplot <- function(...) {
    grattan::grplot(...) + 
    theme_hugh(base_size = 20) + 
    theme(axis.title.x = element_text(margin = ggplot2::margin(10, 0, 10, 0, "pt")), 
          plot.margin = ggplot2::margin(11, 11, 11, 11, "pt"))
}

ggplot2::update_geom_defaults("text", new = list(size = 20/(14/5)))
@
...
\newpage
\section{Labels so as to appear outside the chart (clip $x$-axis)}
...
\newpage
\section{Grattan function for stacked bar chart with right labels}

<<stacked-bar-chart-with-right-labels>>=
read.table(text="Column1	NSW	VIC	QLD	SA	WA	Other
2007	779	828	475	1,037	262	99
2008	2,890	2,036	3,087	3,456	2,068	527
2009	14,008	8,429	18,283	8,569	11,157	2470
...
\eject
\null\vfill
\includegraphics[width=\columnwidth]{atlas/stacked-bar-chart-with-right-labels-1}
\newpage
...
<<facetted-area-chart, eval=FALSE>>=
